...
//-----------------------------------------------
 // sort list containing many elements of a user-defined type
 
 @Test
 public void testManyUserDefinedType(){
   Sorter<Person> sorter = createSorter();
   Person[] people = { new Person("Tan"), new Person("Joe") };
   sorter.sort(people);
   Person[] sorted = { new Person("Joe"), new Person("Tan")};
