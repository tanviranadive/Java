 ...
 * 
 * @author Tanvi
 * Test suite for QuickSorter
 *
 */
public class Sorter1Tests {
  
	 /**
     * Method for creating a QuickSorter.
    ...
    // -----------------------------------------------
  	// sort an array of User Defined type Person
  	
  	@Test
  	  public void TestOneUserDefinedArray(){
  	    Sorter<Person> sorter = createSorter();
  	    Person[] people = { new Person("Tanvi"), new Person("Hello")};
  	    sorter.sort(people);
  	    Person[] sorted = {  new Person("Hello"), new Person("Tanvi") };
  	    assertArrayEquals(sorted, people);
  	  }
